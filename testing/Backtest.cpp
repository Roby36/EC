...
static const std::string strategy_code = "ESTX_S1_daily_shortDiv"; /* nome strategia */
static const std::string barSize = "1 day";                       /* grandezza barre */
static const ContractDetails dataContract  = MContractDetails::ESTX50Index();
static const ContractDetails orderContract = MContractDetails::ESTX50Future();
...
static ExitConditions  exit_conditions [] = {OPPOSITE_DIVERGENCE,                     
                                            ...
                                            EXIT_CONDITIONS_END};
static const DivergenceType divType = SHORT; /* tipo di divergenza (breve o lunga)*/
