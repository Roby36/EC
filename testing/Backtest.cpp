...
static const std::string strategy_code = "DAX_S1_hourly_shortDiv";  /* nome strategia  */
static const std::string barSize = "1 hour";                       /* grandezza barre */
...
static ExitConditions  exit_conditions [] = {OPPOSITE_DIVERGENCE,                     
                                            ...
                                            EXIT_CONDITIONS_END};
static const DivergenceType divType = SHORT_DIV; /* tipo di divergenza (breve o lunga) */
...
/* Utilizzando gli strumenti, le condizioni, e gli indicatori definiti qua sopra, inizializziamo strategia */
    Strategy * strat = new Strategy(instr, client->m_tradeData, stop_loss, take_profit, exp_bars,
                                    ...
                                    1.0, divType, max_neg_period, RSI_cond, Boll_cond /* parametri per divergenza negata */
                                    );
/* Aggiungi strategia */
