...
static const std::string strategy_code_1 = "DaxInd_S1_15secs_longDiv";       /* nome strategia  */
static const std::string barSize_1 = "15 secs";                              /* grandezza barre */
...
#ifndef SS_TEST
static const std::string strategy_code_2 = "ESTX_S1_15secs_fut_longDiv";              /* nome strategia  */
static const std::string barSize_2 = "15 secs";                                      /* grandezza barre */
...
static const std::string strategy_code_3 = "NIKKEI_S1_15secs_fut_longDiv";    /* nome strategia  */
static const std::string barSize_3 = "15 secs";                              /* grandezza barre */
...
static const int num_bars = 512;               // retrieval bars to gather initial data     
static const int min_div_period =  1;  
static const int max_div_period = 18;  
static const int max_neg_period = 18;  
static const double take_profit = 0.1;         // very low to test with high frequency bars
static const double stop_loss   = 0.1;
