...
bullEngLowBBColor = 'blue'
bearEngUppBBColor = 'red'
...
bullEngLowBBDirectory = "/Users/roby/Desktop/EC/graphs/data/bullEngLowBB.txt"
bearEngUppBBDirectory = "/Users/roby/Desktop/EC/graphs/data/bearEngUppBB.txt"
...
bullEngLowBB_data = [int(x) for x in getData(bullEngLowBBDirectory)]
bearEngUppBB_data = [int(x) for x in getData(bearEngUppBBDirectory)]
...
plt.scatter(restrictedXvalues(x_values, bullEngLowBB_data),
            restrictedYvalues(closes_data, bullEngLowBB_data), 
            marker=bullEngLowBBShape, label = "bullEngLowBB", color = bullEngLowBBColor, s=MARKERSIZE)
plt.scatter(restrictedXvalues(x_values, bearEngUppBB_data),
            restrictedYvalues(closes_data, bearEngUppBB_data), 
            marker=bearEngUppBBShape, label = "bearEngUppBB", color = bearEngUppBBColor, s=MARKERSIZE)
plt.legend()
